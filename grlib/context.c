...
GrContextInit(tContext *psContext, const tDisplay *psDisplay)
{
    ...
    psContext->ui32Background = 0; // black
    //psContext->ui32Background = ClrDarkOrange;
    ...
    {
#ifdef USE_RYANS_STRING_RENDERER
    	psContext->pfnStringRenderer = GrRyansStringRenderer;
#else
